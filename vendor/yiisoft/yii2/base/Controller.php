...
class Controller extends Component implements ViewContextInterface
{
    ...
    /**
     * @var string the ID of this controller. __set($id) 注册行为
     */
    public $id;
    /**
    ...
    public function runAction($id, $params = [])
    {
        ...
        // call beforeAction on modules  依次调用父模块的beforeaction
    ...
    /**
     * Renders a static string by applying a layout. 在主题中显示个静态的字符串
    ...
    /**
     * Renders a view file. 绕过views特定的目录 直接给出view文件路径
    ...
    {
        $module = $this->module; //如果本模块没有layout 就使用父模块的layout
