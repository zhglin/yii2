...
class Response extends \yii\base\Response
{
     ...
     * @see content 混合类型的数据 转换到$content
     */
    public $data;
    /**
     ...
     * properties will be ignored by [[send()]]. 文件发送
     */
    public $stream;
    /**
     ...
     * or '1.1' if that is not available. http协议版本号
     */
    public $version;
    /**
