...
class Request extends \yii\base\Request
{
     ...
     * @see getBodyParams()
     * 消息体的解析方式
     * application/x-www-form-urlencoded  title=test&sub%5B%5D=1&sub%5B%5D=2&sub%5B%5D=3 常见的
     ...
     * @return HeaderCollection the header collection 请求头信息
     */
    ...
    public function getCsrfToken($regenerate = false)
    {
        if ($this->_csrfToken === null || $regenerate) {
            //获取csrftoken值 如果为空就生成csrftoken值
    ...
    {
        $method = $this->getMethod(); //当前请求的method
